...
public class RegistryProtocol implements Protocol {
    ...
    /**
     * 注册中心暴露服务方法，实际上就是在注册中心上注册服务
     *
     * @param originInvoker dubbo回调方法代理类
     * @param <T>
     * @return
     * @throws RpcException
     */
    ...
    /**
     * 获取真正的服务提供者的Exporter,此处的protocol实际上和com.alibaba.dubbo.config.ServiceConfig的protocol是同一个,
     * 只是一个Protocol的代理类，会根据getProviderUrl(originInvoker)的URL找真正的Protocol实现类，也就是com.alibaba.dubbo.rpc.protocol.dubbo.DubboProtocol
     *
     * @param originInvoker
     * @param <T>
     * @return
    ...
    /**
     * 返回真正服务提供者的URL，对URL参数进行一次过滤，同时去掉了监控url
     *
     * @param originInvoker
     * @return
     */
    ...
    /**
     * 通过invoker的url 获取服务提供的URL，这个URL是服务提供方，即本机的IP地址，包含通过spring 配置文件配置的那些参数
     *
     * @param origininvoker
     * @return
     */
